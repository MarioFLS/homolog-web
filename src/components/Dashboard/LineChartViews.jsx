...
function LineChartViews({ styles }) {
  ...
  const findGraphic = async () => {
    ...
    return getGraphicsOfUser("/ads/impressions", "/ads/associate/impressions", userHeader, setGraphic, t);
  };
  useEffect(() => {
    findGraphic();
  }, [userHeader]);
